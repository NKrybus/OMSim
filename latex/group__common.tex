...
Collaboration diagram for Common stuff\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{group__common}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em This class is responsible for managing info of detected photons and writing the results in the desired format. \end{DoxyCompactList}\item 
