...
User-\/defined material data are stored in JSON files under \textquotesingle{}/common/data\textquotesingle{} to minimize file length (the original detector construction had over 4,000 lines, mainly due to material properties!). The \textquotesingle{}\mbox{\hyperlink{class_input_data_manager}{Input\+Data\+Manager}}\textquotesingle{} (\mbox{\hyperlink{_o_m_sim_input_data_8hh}{OMSim\+Input\+Data.\+hh}}) loads these properties directly into the Geant4 framework. Materials loaded via this class can be retrieved using Geant4\textquotesingle{}s conventional method \textquotesingle{}G4\+Material\+::\+Get\+Material\textquotesingle{}, but the framework also provides the wrapper \textquotesingle{}\mbox{\hyperlink{class_input_data_manager_a05b5637e4b31dbaaede67d40a139528e}{Input\+Data\+Manager\+::get\+Material}}\textquotesingle{} to handle default parameters. The class also provides an analogue method for optical surfaces \textquotesingle{}\mbox{\hyperlink{class_input_data_manager_ae6ae987535a442a42ad47d53394ade56}{Input\+Data\+Manager\+::get\+Optical\+Surface}}\textquotesingle{} which does not exists in Geant4.

Since different materials have different type of properties, the data is loaded in multiple ways. These different material types are defined in \mbox{\hyperlink{_o_m_sim_data_file_types_8hh}{OMSim\+Data\+File\+Types.\+hh}}. Additionally, geometry data used during PMT construction are also stored in JSON files (\textquotesingle{}/common/data/\+PMTs\textquotesingle{}). These are saved in a \char`\"{}tree\char`\"{} (essentially a dictionary containing the JSON file\textquotesingle{}s keys and values) in \textquotesingle{}\mbox{\hyperlink{class_parameter_table_a749bc840cf2aea18fb5b63da8b68c23c}{Input\+Data\+Manager\+::m\+Table}}\textquotesingle{}. This approach was adopted because various PMTs are constructed similarly, eliminating the need to define a unique class for each PMT type, as is done for the optical modules. Thus, an instance of \textquotesingle{}\mbox{\hyperlink{class_input_data_manager}{Input\+Data\+Manager}}\textquotesingle{} is passed always to all classes related to geometry construction (see \mbox{\hyperlink{group__common_geometry}{geometry}}).

If you wish to load additional data, you can either define a new type in OMSim\+Data\+File\+Types or load it into a tree as previously mentioned. For simpler tasks, use the static method \textquotesingle{}\mbox{\hyperlink{class_input_data_manager_a3a233522b61c65875ebb7b274ff31507}{Input\+Data\+Manager\+::loadtxt}}\textquotesingle{}, which operates similarly to Python\textquotesingle{}s numpy.\+loadtxt. For example\+: 
\begin{DoxyCode}{0}
...
Each optical module and harness is defined in its respective class, located in the \textquotesingle{}/common/geometry\+\_\+construction/\textquotesingle{} folder. These inherit from the virtual base class \textquotesingle{}\mbox{\hyperlink{class_optical_module}{Optical\+Module}}\textquotesingle{}. This inheritance ensures the definition of functions to retrieve the pressure vessel\textquotesingle{}s weight (necessary for radioactive decay studies) and the count of PMTs inside the module. The \textquotesingle{}\mbox{\hyperlink{class_optical_module}{Optical\+Module}}\textquotesingle{} interface inherits from \textquotesingle{}\mbox{\hyperlink{classabc_detector_component}{abc\+Detector\+Component}}\textquotesingle{}, a general helper class simplifying construction. Most \mbox{\hyperlink{class_o_m_sim}{OMSim}} geometries inherit from this class, as illustrated in the dependency diagram below\+: 

The \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_p_m_t_construction}{OMSim\+PMTConstruction}}\textquotesingle{} class constructs PMTs. There are two PMT construction approaches. The first is simple, with a solid photocathode where all entering photons are recorded. The second type simulates the photocathode as a thin layer, also representing the internal components accounting for internal reflections. For more information, refer to Chapter 9 of \href{https://zenodo.org/record/8121321}{\texttt{ Martin Unland\textquotesingle{}s thesis}}. The construction of different PMT models (e.\+g. the 3\textquotesingle{}\textquotesingle{} or 10\textquotesingle{}\textquotesingle{} PMTs) is quite similar. However, the frontal window shape varies among models, leading to diverse combinations of ellipsoids and spheres.
...
\begin{DoxyNote}{Note}
It\textquotesingle{}s important to note that the present methodology stems from historical design decisions. In the future, it would be probably advisable to align this mechanism with the standard Geant4 methodology, utilizing tools such as G4\+SDManager, G4\+VHit, and similar constructs.
\end{DoxyNote}
To detect photons in both simple and complex geometries, the photons must be absorbed within the photocathode volume. This absorption check is performed at the end of each track in the \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_tracking_action_a734f854a881bd97fa2cd056d98566421}{OMSim\+Tracking\+Action\+::\+Post\+User\+Tracking\+Action}}\textquotesingle{} method. The relevant code snippet is as follows\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if} (aTrack-\/>GetDefinition()-\/>GetParticleName() == \textcolor{stringliteral}{"{}opticalphoton"{}})}
\DoxyCodeLine{\{   }
\DoxyCodeLine{    \textcolor{keywordflow}{if} ((aTrack-\/>GetVolume()-\/>GetName()).substr(0, 12) == \textcolor{stringliteral}{"{}Photocathode"{}})}
\DoxyCodeLine{    \{...}

\end{DoxyCode}
 This means, currently, for a volume to be photo-\/sensitive, it must be named \char`\"{}\+Photocathode\char`\"{}. All information regarding absorbed photons is stored in the \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_hit_manager}{OMSim\+Hit\+Manager}}\textquotesingle{} singleton. In this step also \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_p_m_t_response}{OMSim\+PMTResponse}}\textquotesingle{} is called to simulate the PMT response.
...
To analyse and write the output from the data stored in \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_hit_manager}{OMSim\+Hit\+Manager}}\textquotesingle{}, refer to the following example methods for guidance \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_effective_area_analyisis_ad9b76bc60e5f3629a9c693c2a30f539d}{OMSim\+Effective\+Area\+Analyisis\+::write\+Scan}}\textquotesingle{} or \textquotesingle{}\mbox{\hyperlink{class_o_m_sim_decays_analysis_ae35ea36c7616b45b3ca49fff54e2862a}{OMSim\+Decays\+Analysis\+::write\+Hit\+Information}}\textquotesingle{}. \doxysubsection*{Files}
...
\begin{DoxyCompactList}\small\item\em Class to extract and apply scintillation properties to existing materials. \end{DoxyCompactList}\item 
class \mbox{\hyperlink{class_custom_properties}{Custom\+Properties}}
\begin{DoxyCompactList}\small\item\em This class adds user defined properties to already defined materials. \end{DoxyCompactList}\item 
