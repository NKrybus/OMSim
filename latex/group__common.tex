...
Each optical module and harness is defined in its own class located in folder /common/optical\+\_\+modules/. These inherite from the virtual base class \mbox{\hyperlink{class_optical_module}{Optical\+Module}}, which ensures that we have to define a function for retrieving the weight of the pressure vessel (needed in radioactive decays studies) and also the number of PMTs inside the module. The \mbox{\hyperlink{class_optical_module}{Optical\+Module}} interface inherits from \mbox{\hyperlink{classabc_detector_component}{abc\+Detector\+Component}} which is a general helper class that makes life easier while constructing stuff. Most geometries in \mbox{\hyperlink{class_o_m_sim}{OMSim}} inherit from this class, as can be observed in the following dependence diagram\+:  $<$iframe scrolling=\char`\"{}no\char`\"{} frameborder=\char`\"{}0\char`\"{}           src=\char`\"{}classabc\+\_\+detector\+\_\+component\+\_\+\+\_\+inherit\+\_\+\+\_\+graph.\+svg\char`\"{}           width=\char`\"{}747\char`\"{} height=\char`\"{}187\char`\"{}$>$ 

{\bfseries{This browser is not able to show SVG\+: try Firefox, Chrome, Safari, or Opera instead.}}
