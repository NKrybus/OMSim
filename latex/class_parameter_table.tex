...
A helper class that provides functionalities for handling JSON-\/based data tables.  
...
T Parameter\+Table\+::get\+Value (\begin{DoxyParamCaption}\item[{G4\+String}]{p\+Key,  }\item[{G4\+String}]{p\+Parameter }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
void Parameter\+Table\+::parse\+Key\+Content\+To\+Vector (\begin{DoxyParamCaption}\item[{std\+::vector$<$ T $>$ \&}]{p\+Vector,  }\item[{pt\+::ptree}]{p\+Tree,  }\item[{std\+::basic\+\_\+string$<$ char $>$}]{p\+Key,  }\item[{G4double}]{p\+Scaling,  }\item[{bool}]{p\+Inverse }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
void Parameter\+Table\+::parse\+Key\+Content\+To\+Vector (\begin{DoxyParamCaption}\item[{std\+::vector$<$ T $>$ \&}]{p\+Vector,  }\item[{std\+::basic\+\_\+string$<$ char $>$}]{p\+Map\+Key,  }\item[{std\+::basic\+\_\+string$<$ char $>$}]{p\+Key,  }\item[{G4double}]{p\+Scaling,  }\item[{bool}]{p\+Inverse }\end{DoxyParamCaption})}
