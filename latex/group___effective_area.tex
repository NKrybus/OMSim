...
\DoxyCodeLine{thetas, phis = np.degrees(hp.pix2ang(nside=8,ipix=np.arange(NPIX)))}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordflow}{for} theta, phi \textcolor{keywordflow}{in} zip(thetas, phis):}
\DoxyCodeLine{     system(\textcolor{stringliteral}{"{}./OMSim\_effective\_area -\/n 10000 -\/e 1 -\/d 460 -\/q -\/m 1 -\/c -\/t  "{}}+str(g[0,i])+\textcolor{stringliteral}{"{} -\/f "{}}+str(g[1,i])+ \textcolor{stringliteral}{"{} -\/o Data\_mDOM\_new.txt"{}})}
