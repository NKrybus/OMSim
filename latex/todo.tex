...
\end{DoxyItemize}
\item[Member \mbox{\hyperlink{_o_m_sim_s_n_tools_8hh_a87bfae294d50a9d9ae33e1688d2e6496}{get\+Slopes}} (std\+::vector$<$ G4double $>$ xvals, std\+::vector$<$ G4double $>$ yvals, G4int n\+Points, std\+::vector$<$ G4double $>$ \&x, std\+::vector$<$ G4double $>$ \&f, std\+::vector$<$ G4double $>$ \&a, std\+::vector$<$ G4double $>$ \&Fc)]\label{todo__todo000014}%
