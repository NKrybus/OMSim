...
\end{DoxyItemize}
\item[Member \mbox{\hyperlink{_o_m_sim_s_n_tools_8hh_a201de1f13cd772baa18a6e5aa6b43e39}{Get\+Slopes}} (std\+::vector$<$ G4double $>$ xvals, std\+::vector$<$ G4double $>$ yvals, G4int n\+Points, std\+::vector$<$ G4double $>$ \&x, std\+::vector$<$ G4double $>$ \&f, std\+::vector$<$ G4double $>$ \&a, std\+::vector$<$ G4double $>$ \&Fc)]\label{todo__todo000015}%
