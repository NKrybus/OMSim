...
{\footnotesize\ttfamily G4double OMSim\+SNTools\+::calculate\+Weight (\begin{DoxyParamCaption}\item[{G4double}]{p\+Sigma,  }\item[{G4double}]{p\+Nr\+Targets }\end{DoxyParamCaption})}
...
\item[\mbox{\hyperlink{todo__todo000009}{Todo}}]Handle error cases more robustly than just console output. \end{DoxyRefDesc}
\begin{DoxyReturn}{Returns}
...
{\footnotesize\ttfamily G4double OMSim\+SNTools\+::number\+Of\+Targets (\begin{DoxyParamCaption}\item[{G4int}]{p\+Nr\+Target\+Per\+Molecule }\end{DoxyParamCaption})}
...
Build the energy distribution Fe(\+E) given the input parameters, and uses the inverse CDF algorithm to sample a value for the neutrino energy from Fe(\+E).
